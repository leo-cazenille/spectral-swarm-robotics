...
SOURCES=limmsswarm.c json_state.c util.c colors.c simulation.c dispersion.c

#name of the executable file
EXECUTABLE=limmsswarm
...
SIM_CFLAGS = -c -g -O2 -Wall -std=gnu99 $(USERDEFINED_CFLAGS)  #-I$(KILOHEADERS)

#linking flags for simulated version
SIM_LFLAGS = -lsim -lSDL -lm -ljansson $(USERDEFINED_LFLAGS)
